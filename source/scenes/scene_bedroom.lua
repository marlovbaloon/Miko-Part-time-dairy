...
function bedroom.load(saveData)
    ...
    -- =======================================================
    if myCamera then
        myCamera:setAngle(45) -- มุมเอียงกำลังสวยสำหรับเฉลียงห้อง
        myCamera:setZoom(1.0) -- ซูม 1.0 เพื่อให้เห็นขอบเขตหน้าจอเสมือน 320x320 ครบถ้วน
        myCamera.x = 160      -- วาร์ปกล้องมาอยู่ใจกลางตารางห้องนอน 10x10 ช่องก่อน
        myCamera.y = 160
    end
end
